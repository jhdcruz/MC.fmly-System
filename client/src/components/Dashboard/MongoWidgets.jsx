...
// * Inventory
export const TotalSuppliers = memo(() => {
  return (
...
export const TotalProducts = memo(() => {
  return (
...
export const InventoryValue = memo(() => {
  return (
...
export const InventoryTotal = memo(() => {
  return (
...
export const InventoryCapacity = memo(() => {
  return (
...
// * Transactions / Orders
export const TotalRevenue = memo(() => {
  return (
...
export const PendingOrders = memo(() => {
  return (
...
export const CompletedOrders = memo(() => {
  return (
