...
export const TotalByCategory = memo(() => {
  return (
...
export const TotalByTypes = memo(() => {
  return (
...
export const ProductQuantityLines = memo(() => {
  return (
...
export const OrdersPerMonth = memo(() => {
  return (
